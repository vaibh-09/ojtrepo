    ...
    >
      ...
      <div className="absolute left-[5%] md:left-[8%] top-[160px] md:top-[22dvh] z-10 w-[90%] md:w-full max-w-[450px] md:max-w-[550px] flex flex-col gap-[60px] md:gap-[100px]">
        ...
        <div className="w-full pb-10 md:pb-20">
          <div className="flex flex-col gap-[16px] md:gap-[20px] px-12 md:px-16 py-10 md:py-12 bg-[rgba(255,240,200,0.35)] backdrop-blur-[18px] border-none rounded-[24px] md:rounded-[32px] max-w-[600px] shadow-sm leading-[1.6]">
